<%-- 
    Document   : home
    Created on : Nov 5, 2018, 7:48:21 AM
    Author     : Lian CahJaya
--%>
...
<div class="container">
	...
	<p>Modul RSBK - Kelompok07</p>
        <h5>Selamat Datang, <%=session.getAttribute("loginName")%></h6></center>
    </div>
    <div background="background.jpg"  class="row content col-md-8 col-md-offset-2">
	<div class="col-md-3 menu">
	<ul class="nav nav-pills nav-stacked" style="">
            <li><a href="#">Home</a></li>
            <li><a href="/Modul3_kel07/login.jsp">Logout</a></li>
	</ul>
	</div>
	<div  class="col-md-9 daftar">
            <form action="./StudentServlet" method="POST">
                ...
                <tr>
                <td>Alamat</td>
                <td><input class="form-control" type="text" name="lastname" value="${student.alamat}" /></td>
                </tr>
                <tr>
                <td colspan="2">
