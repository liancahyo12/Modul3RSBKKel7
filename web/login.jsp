<%-- 
    Document   : login
    Created on : Nov 5, 2018, 7:47:20 AM
    Author     : Lian CahJaya
--%>
...
<head>
    ...
    <style>
      ...
      .nav{
        padding: 0px; 
        border: 1px solid #ff21ff;
        border-radius: 5px;
      }
      .nav li{
        border-bottom: 1px solid #ff21ff;
        border-radius: 5px;
      }
        ...
        <div class="row content">
          <div class="col-md-12">
            <div class="col-md-4 col-md-offset-4 daftar">
              ...
              <form method="POST" action="/Modul3_kel07/LoginServlet" class="login">
